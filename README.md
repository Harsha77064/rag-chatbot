        ...
        - - ⚡ Fast responses powered by Gemini 2.0 Flash
          ...
          - - A [Google AI Studio](https://aistudio.google.com/) API key (free tier available)
            ...
            - ```bash
              ...
              > 2. 2. Wait for the document to be processed (chunk count and page count will be shown)
              >    3. 3. **Ask** any question in the chat input
              >       4. 4. View the **answer** along with expandable **source excerpts** and page numbers
              >          5. 5. Ask follow-up questions — the chatbot remembers the conversation
              >             6. 6. Click **"Upload New PDF"** to start fresh with a different document
              >               
              >                7. ---
              >               
              >                8. ## 📁 Project Structure
              ...
              > ## 🙋 Author
              >
              > **Harshith Killada** — [GitHub](https://github.com/Harsha77064) · [LinkedIn](https://linkedin.com/in/harshit-killada-5a8040295) · [LeetCode](https://leetcode.com/u/HarshithKillada/)
              >
              > ---
              >
              > ## 📄 License
